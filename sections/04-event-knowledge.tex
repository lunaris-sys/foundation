...
VLDB. In October 2025, Kùzu Inc. was acquired by Apple and archived the
open-source Kuzu repository without a migration path. Ladybug emerged as the
primary community-maintained continuation: it carries the full Kuzu codebase,
Cypher API, and Rust bindings forward under the same MIT license, with active
releases continuing from where Kuzu left off.
