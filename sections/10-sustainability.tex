...
and collecting basic system events. The base distribution decision between Fedora and OpenSUSE
Slowroll~\cite{opensuse:slowroll} is pending and will be made before Phase 1
begins.
