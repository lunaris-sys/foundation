...
system-wide knowledge graph, a structured project system, AI interfaces, and
modern tooling not as features bolted on top, but as foundational
infrastructure. It takes a clear stance on user sovereignty, independence from
dominant platform vendors, and not being annoying to use.
If an operating system is being built in 2026 anyway, there is no reason to
...
than large ones: a system that remembers what you were working on, groups your
files and activity into projects without requiring manual organization, or
switches themes everywhere in one action, earns trust faster than an impressive
feature nobody uses. Coherence matters too: shared configuration, shared
theming, shared interfaces across all components. No part of the system should
look like it was designed in a different decade by a different team.
...
compatibility bridges rather than replacements. Native applications are
distributed as RPM packages; Flatpak serves as a compatibility layer for
third-party applications not distributed through the Store. Standard hardware
interfaces work; nothing is deliberately broken for the sake of purity. The system can explain what it is doing, in
