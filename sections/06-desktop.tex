...
metadata about the target -- project membership, last accessed timestamp,
which application last modified the file -- enabling precise conditional
...
Applications add entries to system context menus -- right-click on files,
...
\paragraph{Ambient.}
Applications influence the visual state of the desktop subtly -- a slow pulse
of the accent color while a build runs, a warning tint when tests fail. Ambient
